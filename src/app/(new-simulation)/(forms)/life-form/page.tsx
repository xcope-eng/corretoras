...
export default function ChooseInsurance() {
  ...
  const generateOffers = (clientData: ClientData) => {
    return insuranceCompanies.life.map(company => {
      const product = company.products[0];
      const premium = calculatePremium(product.basePremium, clientData, 'life');
  ...
  return (
    <div className="page-content">
      <div className="page-header">
        <h2>Formulário de Simulação de Seguro de Vida</h2>
      </div>
      ...
      {showOffers && (
        <div className="mt-10">
          <div className="page-header">
            <h2>Ofertas de Seguros de Vida</h2>
