    ...
    <div className="page-content">
        ...
        <div className={`row mt-4 ${styles.insuranceTypesGrid}`}>
            <div className="col-md-3 mb-4">
                <Link href="/seguros/travel-form" className="no-underline">
            ...
            <div className="col-md-3 mb-4">
                <Link href="/seguros/life-form" className="no-underline">
            ...
            <div className="col-md-3 mb-4">
                <Link href="/seguros/auto-form" className="no-underline">
            ...
            <div className="col-md-3 mb-4">
                <Link href="/seguros/health-form" className="no-underline">
